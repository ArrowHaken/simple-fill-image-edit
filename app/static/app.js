...
function taskProvider(t){const provider=t.artifacts?.provider_record?.provider;if(provider==='dreamina-image-edit-fallback')return '即梦兜底';if(provider)return 'Image2';return '';}
